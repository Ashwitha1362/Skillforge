...
class SkillForgeApp:
    def __init__(self, root):
        ...
        self.root.configure(bg="#f4f6f7")  # light background
    ...
    def create_login_screen(self):
        ...
        self.root.configure(bg="#1abc9c")  # teal background
    ...
    def create_main_screen(self):
        ...
        self.root.configure(bg="#34495e")  # dark background
